...
# ---------- 草稿管理 ----------
def create_draft_dir(article_dir: Path, draft_no: int) -> Path:
    draft_dir = article_dir / f"draft_{draft_no:02d}"
    draft_dir.mkdir(parents=True, exist_ok=True)
    return draft_dir

def save_draft(article_dir: Path, draft_no: int, main_tex: str, headerfooter_tex: str, content_tex: str):
    draft_dir = create_draft_dir(article_dir, draft_no)
    (draft_dir / "main.tex").write_text(main_tex, encoding="utf-8")
    (draft_dir / "headerfooter.tex").write_text(headerfooter_tex, encoding="utf-8")
    (draft_dir / "content.tex").write_text(content_tex, encoding="utf-8")
