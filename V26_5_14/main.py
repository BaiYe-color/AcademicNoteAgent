...
from ai_client import (
    ...
    generate_outline, NOTE_STYLE_CONFIG, extract_latex_body,
    DEEPSEEK_API_KEY
)
...
def process_pdf(file_path, config, skip_reflect=False, skip_revise=False, resume_state=None, batch_mode=False, template_choice=None):
                ...
                while outline_round < 2:
                    ...
                    if user_input.lower() == "skip":
                        ...
                        try:
                            ...
                            console.print("\n[bold cyan]📋 调整后的内容大纲[/bold cyan]")
                            console.print(outline)
                            console.print("\n[bold]请确认大纲：[/bold] 回车=确认，输入修改意见=继续调整，skip=不使用大纲")
    ...
    elif skip_revise and not resume_state:
